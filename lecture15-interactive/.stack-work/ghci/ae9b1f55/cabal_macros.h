...
/* package interactive-0.1 */
#ifndef VERSION_interactive
#define VERSION_interactive "0.1"
#endif /* VERSION_interactive */
#ifndef MIN_VERSION_interactive
#define MIN_VERSION_interactive(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_interactive */
...
#define CURRENT_COMPONENT_ID "interactive-0.1-KL1qYOhBDIn53jmVe7dlCX-interactive"
